...
var btnStatus = function(has){
  ...
  // var nawPause = _thisI.hasClass('fa-pause-circle');
  var nowPause = has | false; //값이 있으면 쓰고 없으면 실행하지말아라.없으면 else값이 적용됨
...
bannerBox.on({'mouseenter': stopSlide, 'mouseleave':btnStatus});//객체형식에서 startSlide메소드체인을 쓰면 오류가남 그냥 명칭만던져줘야함.
